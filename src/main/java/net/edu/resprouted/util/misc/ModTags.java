...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> JARS = createTag("jars");
        public static final TagKey<Block> URNS = createTag("urns");
    ...
    public static class Items {
        ...
        public static final TagKey<Item> JARS = createTag("jars");
        public static final TagKey<Item> URNS = createTag("urns");

...
import net.edu.resprouted.screen.slot.ModifierSlot;
...
public class AdvancedCondenserScreenHandler extends ScreenHandler {
    ...
    public AdvancedCondenserScreenHandler(int syncId, PlayerInventory playerInventory, AdvancedCondenserBlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        ...
        this.addSlot(new ModifierSlot(inventory, 3, 66, 7));
    ...
    public ItemStack quickMove(PlayerEntity player, int index) {
        ...
        if (slot.hasStack()) {
            ...
            if (index < inventory.size()) {
                ...
                if (ModifierSlot.matches(originalStack)) {
                    if (!this.insertItem(originalStack, 3, 4, false))
                        return ItemStack.EMPTY;
                }
                else if (CondenserFuelSlot.isFuel(originalStack)) {

...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        register(context, IRONWOOD_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new StraightTrunkPlacer(16, 1, 0),
                BlockStateProvider.of(ModBlocks.IRONWOOD_LEAVES),
                new CustomIronWoodFoliagePlacer(ConstantIntProvider.create(4), ConstantIntProvider.create(0)),
        ...
        register(context, OLIVE_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
                ...
                new CustomOliveFoliagePlacer(ConstantIntProvider.create(1), ConstantIntProvider.create(0)),

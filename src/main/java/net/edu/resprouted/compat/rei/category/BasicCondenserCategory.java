...
public class BasicCondenserCategory implements DisplayCategory<BasicCondenserDisplay> {
    ...
    public static final CategoryIdentifier<BasicCondenserDisplay> ID = CategoryIdentifier.of(Resprouted.MOD_ID, "plugin/basic_alchemy");

    @Override
    public CategoryIdentifier<? extends BasicCondenserDisplay> getCategoryIdentifier() {
        return ID;
    }
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModBlocks.BASIC_CONDENSER);
    }
    ...
    @Override
    public List<Widget> setupDisplay(BasicCondenserDisplay display, Rectangle bounds) {

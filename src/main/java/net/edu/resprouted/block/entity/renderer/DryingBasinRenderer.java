...
public class DryingBasinRenderer implements BlockEntityRenderer<DryingBasinBlockEntity> {
    public DryingBasinRenderer(BlockEntityRendererFactory.Context context) {
    }
    @Override

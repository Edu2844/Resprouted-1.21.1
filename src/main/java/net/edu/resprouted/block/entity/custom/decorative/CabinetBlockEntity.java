...
public class CabinetBlockEntity extends LootableContainerBlockEntity implements ImplementedInventory {
    ...
    public Inventory getCombinedInventory() {
        ...
        BlockPos otherPos = type == CabinetType.BOTTOM ? pos.up() : pos.down();
        assert world != null;
        BlockEntity otherBE = world.getBlockEntity(otherPos);

        if (otherBE instanceof CabinetBlockEntity otherCabinet) {
            return type == CabinetType.BOTTOM
                    ? new DoubleInventory(otherCabinet, this)
                    : new DoubleInventory(this, otherCabinet);
        }

...
public class ChandelierBlock extends FallingBlock {
    ...
    protected static final VoxelShape SHAPE = VoxelShapes.union(
            Block.createCuboidShape(0.0F, 0.0F, 0.0F, 16.0F, 4.0F, 1.0F),
            Block.createCuboidShape(0.0F, 0.0F, 15.0F, 16.0F, 4.0F, 16.0F),
            Block.createCuboidShape(0.0F, 0.0F, 1.0F, 1.0F, 4.0F, 15.0F),
            Block.createCuboidShape(15.0F, 0.0F, 1.0F, 16.0F, 4.0F, 15.0F),
            Block.createCuboidShape(5.0F, 15.0F, 5.0F, 11.0F, 16.0F, 11.0F)
    );

...
public abstract class IronBerryJuice extends BaseFluid {
    ...
    public Fluid getStill() {
        return ModFluids.IRON_BERRY_JUICE;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.IRON_BERRY_JUICE.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

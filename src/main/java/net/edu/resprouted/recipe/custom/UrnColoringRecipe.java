...
public class UrnColoringRecipe extends SpecialCraftingRecipe {
    public UrnColoringRecipe(CraftingRecipeCategory category) {
        super(category);
    }
    ...
    public boolean matches(CraftingRecipeInput craftingRecipeInput, World world) {
        ...
        for (int k = 0; k < craftingRecipeInput.getSize(); k++) {
            ...
            if (!itemStack.isEmpty()) {
                if (Block.getBlockFromItem(itemStack.getItem()) instanceof UrnBlock) {
                    i++;
                } else {
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        for (int i = 0; i < craftingRecipeInput.getSize(); i++) {
            ...
            if (!itemStack2.isEmpty()) {
                ...
                if (Block.getBlockFromItem(item) instanceof UrnBlock) {
        ...
        Block block = UrnBlock.get(dyeItem != null ? dyeItem.getColor() : null);
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.URN_COLORING;
    }
}

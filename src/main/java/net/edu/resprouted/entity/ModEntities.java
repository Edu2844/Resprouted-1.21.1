...
public class ModEntities {
    ...
    public static final Identifier OLIVE_BOAT_ID = Identifier.of(Resprouted.MOD_ID, "olive_boat");
    public static final Identifier OLIVE_CHEST_BOAT_ID = Identifier.of(Resprouted.MOD_ID, "olive_chest_boat");

    public static final Identifier IRONWOOD_BOAT_ID = Identifier.of(Resprouted.MOD_ID, "ironwood_boat");
    public static final Identifier IRONWOOD_CHEST_BOAT_ID = Identifier.of(Resprouted.MOD_ID, "ironwood_chest_boat");

    public static final RegistryKey<TerraformBoatType> OLIVE_BOAT_KEY = TerraformBoatTypeRegistry.createKey(OLIVE_BOAT_ID);

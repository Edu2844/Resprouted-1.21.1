...
public class ModFoodComponents {
    ...
    public static final FoodComponent OLIVE_OIL = new FoodComponent.Builder().nutrition(0).saturationModifier(0.4f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.NAUSEA,580,1,true, false, false),1f).build();
    ...
    public static final FoodComponent VANTA_OIL = new FoodComponent.Builder().nutrition(0).saturationModifier(0.4f).alwaysEdible().statusEffect(new StatusEffectInstance(StatusEffects.BLINDNESS,580,0,true, false, false),1f).build();

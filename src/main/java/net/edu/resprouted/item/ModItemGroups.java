    ...
    public static  final ItemGroup DECORATION_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModBlocks.POLISHED_SLATE))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.BIRCH_CABINET);
                        entries.add(ModBlocks.JUNGLE_CABINET);
                        entries.add(ModBlocks.ACACIA_CABINET);
                        entries.add(ModBlocks.DARK_OAK_CABINET);
                        entries.add(ModBlocks.MANGROVE_CABINET);
                        entries.add(ModBlocks.CHERRY_CABINET);
                        entries.add(ModBlocks.CRIMSON_CABINET);
                        entries.add(ModBlocks.WARPED_CABINET);
                        ...
                        entries.add(ModBlocks.ORNATE_LANTERN);
                        entries.add(ModBlocks.ORNATE_SOUL_LANTERN);
                        entries.add(ModBlocks.ORNATE_GOLD_LANTERN);
                        entries.add(ModBlocks.ORNATE_GOLD_SOUL_LANTERN);
                        entries.add(ModBlocks.ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.EXPOSED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.WEATHERED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.OXIDIZED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.WAXED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.WAXED_EXPOSED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.WAXED_WEATHERED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.WAXED_OXIDIZED_ORNATE_COPPER_LANTERN);
                        entries.add(ModBlocks.ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.EXPOSED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.WEATHERED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.OXIDIZED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.WAXED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.WAXED_EXPOSED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.WAXED_WEATHERED_ORNATE_COPPER_SOUL_LANTERN);
                        entries.add(ModBlocks.WAXED_OXIDIZED_ORNATE_COPPER_SOUL_LANTERN);
                        ...
                        entries.add(ModBlocks.WHITE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIGHT_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BLACK_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BROWN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.RED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.ORANGE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.YELLOW_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIME_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.GREEN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.CYAN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIGHT_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.PURPLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.MAGENTA_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.PINK_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.EXPOSED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_WHITE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIGHT_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BLACK_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BROWN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_RED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_ORANGE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_YELLOW_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIME_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_GREEN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_CYAN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIGHT_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_PURPLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_MAGENTA_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_PINK_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.WEATHERED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_WHITE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIGHT_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BLACK_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BROWN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_RED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_ORANGE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_YELLOW_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIME_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_GREEN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_CYAN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIGHT_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_PURPLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_MAGENTA_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_PINK_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.OXIDIZED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_WHITE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIGHT_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_GRAY_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BLACK_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BROWN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_RED_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_ORANGE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_YELLOW_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIME_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_GREEN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_CYAN_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIGHT_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BLUE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_PURPLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_MAGENTA_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_PINK_COPPER_CANDLE_HOLDER);
                        ...
                        entries.add(ModBlocks.DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WHITE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIGHT_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BLACK_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BROWN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.RED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.ORANGE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.YELLOW_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIME_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.GREEN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.CYAN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.LIGHT_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.PURPLE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.MAGENTA_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.PINK_DOUBLE_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.EXPOSED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_WHITE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIGHT_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BLACK_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BROWN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_RED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_ORANGE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_YELLOW_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIME_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_GREEN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_CYAN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_LIGHT_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_PURPLE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_MAGENTA_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.EXPOSED_PINK_DOUBLE_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.WEATHERED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_WHITE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIGHT_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BLACK_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BROWN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_RED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_ORANGE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_YELLOW_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIME_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_GREEN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_CYAN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_LIGHT_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_PURPLE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_MAGENTA_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.WEATHERED_PINK_DOUBLE_COPPER_CANDLE_HOLDER);

                        entries.add(ModBlocks.OXIDIZED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_WHITE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIGHT_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_GRAY_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BLACK_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BROWN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_RED_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_ORANGE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_YELLOW_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIME_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_GREEN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_CYAN_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_LIGHT_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_BLUE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_PURPLE_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_MAGENTA_DOUBLE_COPPER_CANDLE_HOLDER);
                        entries.add(ModBlocks.OXIDIZED_PINK_DOUBLE_COPPER_CANDLE_HOLDER);
    ...
    public static  final ItemGroup ALCHEMY_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.ELIXIR_ICON))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.BASIC_CONDENSER);
                        entries.add(ModBlocks.BASIC_RETORT);

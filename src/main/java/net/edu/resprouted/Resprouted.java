...
import net.edu.resprouted.networking.EffectSyncHandler;
...
import net.edu.resprouted.registry.ResproutedStuffs;
...
public class Resprouted implements ModInitializer {
	...
	public void onInitialize() {
		...
		BottleInteractions.registerBottleInteractions();
